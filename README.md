...
[cite_start]*Tracks high-level KPIs and monthly revenue trends ($1.83M current month).*

### 2. Geographic Sales Analysis
![Map View](./Dashboard_Map.png)
[cite_start]*Spatial analysis of distribution across North America, Europe, and the Pacific.*

### 3. Product Performance & What-If Analysis
![Product Detail](./Dashboard_Product.png)
[cite_start]*Features performance gauges vs. targets and interactive price adjustment modeling.*

### 4. Customer Segmentation
![Customer Detail](./Dashboard_Customer.png)
[cite_start]*Deep-dive into 17.4K customers by occupation and income level.*

### 5. Advanced Interactivity (Category Tooltip)
![Category Tooltip](./Dashboard_Tooltip.png)
[cite_start]*Custom report-page tooltips providing granular hover-over insights into weekly trends.*
